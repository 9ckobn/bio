...
export const ui = {
  en: {
    ...
    'contact.form.subtitle': 'Drop a note directly to my Telegram inbox. Fast response guaranteed.',
    'contact.form.contact_label': 'Your contact (Telegram @handle, email, or phone)',
    'contact.form.contact_placeholder': '@username or name@company.com',
    'contact.form.message_label': 'Message / Project inquiry',
    'contact.form.message_placeholder': 'Tell me about your project, timeline, or question...',
    'contact.form.submit': 'Send',
    'contact.form.hint': 'I receive messages instantly in Telegram',
    'contact.form.success': '✓ Message delivered! I will get back to you shortly.',
    'contact.form.error': 'Failed to send. Please reach out directly on Telegram.',
  ...
  ru: {
    ...
    'hero.cta_form': 'Связаться со мной',
    ...
    'contact.form.subtitle': 'Сообщение моментально прилетит ко мне в Telegram-бота. Отвечаю быстро.',
    'contact.form.contact_label': 'Ваш контакт (Telegram @юзернейм, email или телефон)',
    'contact.form.contact_placeholder': '@username или name@company.com',
    'contact.form.message_label': 'Сообщение / суть проекта',
    'contact.form.message_placeholder': 'Расскажите о проекте, стеке, сроках или задайте вопрос...',
    'contact.form.submit': 'Отправить',
    'contact.form.hint': 'Получу сообщение моментально',
    'contact.form.success': '✓ Сообщение отправлено! Скоро отвечу.',
    'contact.form.error': 'Не удалось отправить. Пожалуйста, напишите напрямую в Telegram.',
